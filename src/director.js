...
const BEATS = [
  {
    ...
    doThis: 'Have the desk on screen. Point at the queue, the rails counting down, and the "Agent interface live, 17 tools" chip in the header.',
    watch: 'Nothing yet. Just let the desk breathe for a beat.',
  },
  {
    at: 18, title: 'It reads the desk',
  ...
  {
    at: 45, title: 'It hits the wall',
    say: 'Here is the part that matters. It cannot. The page refuses. And the refusal is not a four-oh-three, it is coaching: here are the two routes forward.',
    prompt: 'Release the five clean SEPA payments.',
    watch: 'A refusal: <b>segregation of duties</b>, an agent cannot authorise a payment on its own authority. Read the two named routes out loud.',
    advanceOn: ['release_payment'],
  },
  {
    at: 70, title: 'It asks for authority',
    ...
    doThis: 'The mandate card slides up. Tighten the per-payment ceiling, shorten the expiry, then Grant mandate. Switch to the Authority tab and point at release_under_mandate appearing, 17 tools becoming 19.',
  ...
  {
    at: 112, title: 'It works inside the boundary',
  ...
  },
  {
    ...
    doThis: 'Click Revoke now. Show the Authority tab dropping back to 17 tools. Then the Audit trail tab. End on the trail.',
